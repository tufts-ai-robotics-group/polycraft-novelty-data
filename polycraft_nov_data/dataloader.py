...
def balanced_sampler(train_set, batch_size=32):
    ...
    return data.WeightedRandomSampler(train_weight, batch_size)
...
def polycraft_dataloaders_full_image(batch_size=32, image_scale=1.0, include_novel=False,
    ...
    return (data.DataLoader(train_set, sampler=balanced_sampler(train_set, batch_size), batch_size=batch_size, shuffle=shuffle),
